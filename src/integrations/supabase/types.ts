...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      quotes: {
        Row: {
          ...
          closed_at: string | null;
          closed_reason: Database["public"]["Enums"]["lead_closed_reason_enum"] | null;
    ...
    Enums: {
      ...
      company_invoice_status: "draft" | "sent" | "partially_paid" | "paid" | "void" | "overdue";
      company_service_area_kind: "city" | "zip" | "state" | "radius";
      lead_closed_reason_enum: "won" | "lost" | "cancelled" | "duplicate" | "invalid" | "expired";
      ...
      lead_status_enum:
        ...
        | "rejected"
        | "cancelled";
      partner_application_status: "draft" | "submitted" | "reviewing" | "approved" | "rejected";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
