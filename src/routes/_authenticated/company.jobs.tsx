...
import { useCompanyJobs, useMyCompany, type AvailableJob } from "@/lib/company-jobs";
    ...
    <div className="space-y-5">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Broker-qualified moves open to every approved company. First to claim owns the job.
        </p>
      </header>
      ...
      {available.length === 0 ? (
        <EmptyState
          ...
          body="New qualified leads appear here instantly — no refresh needed."
        />
      ) : (
