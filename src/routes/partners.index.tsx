...
const FAQ = [
  {
    q: "How do I become an Easy Moving partner?",
    a: "Fill out the partner application. We verify your DOT/MC and insurance and approve within 1–3 business days.",
  },
  {
    q: "How much do leads cost?",
    a: "Exclusive local leads start around $40. Marketplace leads are lower. There is no monthly minimum.",
  },
  {
    q: "Do I need to sign a contract?",
    a: "No — Easy Moving is pay-per-lead with no long-term commitment.",
  },
  {
    q: "How are leads generated?",
    a: "Organic SEO, our AI-powered instant quote calculator, and paid channels we run ourselves.",
  },
  {
    q: "Can I choose the areas I serve?",
    a: "Yes — set state, city, and radius coverage during onboarding.",
  },
];
  ...
  return (
    <SiteLayout>
        ...
        items={[
          {
            ...
            body: "12-hour claim window before a lead opens to the marketplace. No shared lists.",
          },
          {
            title: "Open marketplace",
            body: "Unclaimed leads flow into a first-come marketplace. Capped at 4 partners per lead.",
          },
          {
            title: "Built-in CRM",
            body: "Track every lead from first call to final payment on one timeline.",
          },
          {
            title: "Estimate builder",
            body: "Itemized labor, truck, packing, and supplies. Branded PDFs in under two minutes.",
          },
          {
            title: "Dispatch board",
            body: "Day, week, and month views. Assign trucks and crews, prevent double-bookings.",
          },
          {
            title: "Invoicing",
            body: "Deposits, final balances, and extras. Generate PDFs and email in one click.",
          },
        ]}
      />
      ...
      <Benefits
        ...
        items={[
          {
            title: "Real customers, not tire kickers",
            body: "Every lead comes with a verified phone, verified email, and full move details — origin, destination, inventory, and dates.",
          },
          {
            title: "You keep 100% of the revenue",
            body: "Unlike traditional moving brokers, we don't take a cut of your jobs. You set the price, you keep the customer.",
          },
          {
            title: "Purpose-built for movers",
            body: "The CRM, estimator, and dispatch are designed by people who've worked in the moving industry — not repurposed from generic tools.",
          },
          {
            title: "Grow at your own pace",
            body: "Set your daily lead cap, choose the markets you serve, and pause any time. No contracts, no monthly minimums.",
          },
        ]}
      />
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16">
          <h2 className="font-serif text-3xl md:text-4xl font-semibold tracking-tight">
            Partner coverage across the U.S.
          </h2>
          <p className="mt-3 max-w-2xl text-muted-foreground">
            We serve moving companies in every state. Click your state to see local pricing and
            coverage.
          </p>
