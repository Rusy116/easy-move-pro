...
const FAQ = [
  { q: "Are these moving resources free?", a: "Yes. Every guide, checklist, video and download in the resources center is free to use." },
  { q: "What is the difference between resources and the store?", a: "Resources are free reference material. The digital store sells polished, editable planning products such as full budget workbooks and inventory systems." },
  { q: "How far in advance should I start planning?", a: "Eight weeks is comfortable for a household move, four weeks is workable, and two weeks is possible with full-service packing." },
];
    ...
    <SiteLayout>
      ...
      <section className="border-b border-border">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-24">
          <span className="text-xs font-semibold uppercase tracking-widest text-ochre">Free resources</span>
          <h1 className="mt-3 font-serif text-5xl font-medium">Everything you need to move well.</h1>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {items.map((r) => {
              ...
              return (
                <article key={r.slug} className="flex flex-col rounded-2xl border border-border bg-card p-6">
                  ...
                  <div className="mt-5 flex items-center justify-between text-xs text-muted-foreground">
                    <span className="rounded-full border border-border px-2.5 py-1 capitalize">{r.kind}</span>
